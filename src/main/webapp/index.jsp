...
<html>
  <head>
    ...
    <!-- Ionicons -->
    <link href="res/css/ionicons.min.css" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
  ...
  <body class="skin-blue sidebar-mini">
            ...
            <ul class="nav navbar-nav">
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <!-- User Image -->
                            <img src="res/img/user2-160x160.jpg" class="img-circle" alt="User Image"/>
                          </div>
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="res/img/user2-160x160.jpg" class="user-image" alt="User Image"/>
                  <!-- hidden-xs hides the username on small devices so only the image appears. -->
                  <span class="hidden-xs"><%=s.getAttribute("username")%></span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="res/img/user2-160x160.jpg" class="img-circle" alt="User Image" />
                    <p>
                      <%=s.getAttribute("username")%> - Web Developer
    ...
    <script>
      seajs.use("general/index",function(indexControl){
          indexControl.init();
      });
    </script>
  </body>
